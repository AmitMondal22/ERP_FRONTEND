...
class returnPurchaseController {
  ...
  createReturn = async (req, res) => {
    try {
      ...
      const insertId = await insertData("td_return_purchase_product", { quality_material });

      return res.json({ success: true, message: "Return purchase created", return_id: insertId });
